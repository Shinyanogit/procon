...
for i in range(
    ...
    for A_i, B_i, B_max in dp[-1]:
        ...
        b_max = max(B_max, b)
        dp.append([])
        dp[-1].append((A_i, B_i, b_max))
        print(A_i, B_i)
max_length = 0
for A_ans, B_ans, trash in dp[-1]:
    max_length = max(len(A_ans) + len(B_ans), max_length)
print(max_length)
